...
!-----------------------------VARIABLES------------------------------      
      ...
      integer             :: ktime,L,LL,nveclen,stage    !do loops,notstage
...
!--------------------------TIMESTEP LOOP------------------------------
            ...
            stage=1
            call problemsub(iprob,stage,uvec,ep,uexact,dt,nveclen,tfinal,resE(1,L),resI(1,L),aI(L+1,L+1),xjac)
...
!--------------------------------RK LOOP------------------------------
              do L = 1,nrk    
                ...
                stage=2
                call problemsub(iprob,stage,uvec,ep,uexact,dt,nveclen,tfinal,iDT,resE(1,L),resI(1,L),aI(L+1,L+1),xjac)
...
!-------------------------------NEWTON ITERATION----------------------
                do k = 1,20
                  ...
                  enddo
                  stage=2
                  call problemsub(iprob,stage,uvec,ep,uexact,dt,nveclen,tfinal,iDT,resE(1,L+1),resI(1,L+1),aI(L+1,L+1),xjac)
