...
!--------------------------TIMESTEP LOOP------------------------------
            ...
            stage=0
            call problemsub(iprob,stage,uvec,ep,uexact,dt,nveclen,tfinal,iDT)!,resE(1,1),resI(1,1),aI(1,1),xjac)
...
!--------------------------------RK LOOP------------------------------
              do L = 1,nrk    
                ...
                stage=1
                call problemsub(iprob,stage,uvec,ep,uexact,dt,nveclen,tfinal,iDT,resE(1,L),resI(1,L))!,aI(1,1),xjac)
